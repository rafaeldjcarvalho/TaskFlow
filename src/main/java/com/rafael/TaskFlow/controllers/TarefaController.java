...
public class TarefaController {
	...
	@PostMapping("/addTask/column/{column_id}")
	public ResponseEntity<TarefaDTO> criarTarefa(@RequestBody TarefaDTO data, @PathVariable Long column_id) {
		TarefaDTO result = service.createTask(data, column_id);
		return ResponseEntity.ok(result);
	}
	
	@PutMapping("/{task_id}")
	public ResponseEntity<TarefaDTO> atualizarTarefa(@PathVariable Long task_id, @RequestBody TarefaDTO data) {
		TarefaDTO result = service.updateTask(task_id, data);
		return ResponseEntity.ok(result);
	}
	
	@PutMapping("/{task_id}/mover")
	public ResponseEntity<TarefaDTO> moverTarefa(@PathVariable Long task_id, @RequestBody MoverTarefaDTO data) {
